...
class P4(ProductionBase):
    def __init__(self):
        ...
        enode5 = self.graph.add_edge(node4, node6)
        enode6 = self.graph.add_edge(node6, node1)
    ...
    def apply_production(self, graph, mapping):
        ...
        graph.add_q_node(mapping[self.nodes[5]], node, v3, mapping[self.nodes[3]])
