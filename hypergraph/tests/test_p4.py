...
class TestP4Production(unittest.TestCase):
    ...
    def setUpIncompleteGraphWithMissingEdge(self):
        ...
        self.missing_edge_node6 = Node(0, 2.5, 1)
    ...
    #     # Ustawienie dla grafu z niepoprawnymi współrzędnymi (używane w teście test_p4_production_does_not_apply_because_incorrect_coordinates)
    ...
    # def test_p4_production_does_not_apply_because_incorrect_coordinates(self):
