...
from hypergraph.productions.p3 import P3


class TestP3Production(unittest.TestCase):
    def setUpCompleteGraph(self):
        # Ustawienie dla kompletnego grafu (używane w teście test_p3_production_applies)
        self.node1 = Node(0, 0, 0)
        self.node2 = Node(5, 0, 0)
        self.node3 = Node(5, 5, 0)
        self.node4 = Node(0, 5, 0)
        self.node5 = Node(5, 2.5, 1)
        self.node6 = Node(2.5, 0, 1)
        self.graph = Graph()
        ...
        self.qnode.R = 1
        self.graph.add_edge(self.node1, self.node6)
        self.graph.add_edge(self.node6, self.node2)
    ...
    def setUpRolledGraph(self):
        # Ustawienie dla kompletnego grafu obroconego(używane w teście test_p3_production_applies_to_rolled_graph)
        self.node1 = Node(0, 0, 0)
        self.node2 = Node(5, 0, 0)
        self.node3 = Node(5, 5, 0)
        self.node4 = Node(0, 5, 0)
        self.node5 = Node(0, 2.5, 1)
        ...
        self.graph.add_edge(self.node5, self.node1)

    def setUpLargerCompleteGraph(self):
        # Ustawienie dla kompletnego grafu (używane w teście test_p3_production_applies_to_larger_graph)
        self.node1 = Node(0, 0, 0)
        self.node2 = Node(5, 0, 0)
        self.node3 = Node(5, 5, 0)
        self.node4 = Node(0, 5, 0)
        self.node5 = Node(5, 2.5, 1)
        self.node6 = Node(2.5, 0, 1)
        self.node7 = Node(5, 7.5, 0)
        self.node8 = Node(0, 7.5, 0)
        self.graph = Graph()
        self.graph.add_node(self.node1)
        self.graph.add_node(self.node2)
        self.graph.add_node(self.node3)
    ...
    def setUpIncompleteGraphWithMissingVertex(self):
        # Ustawienie dla niekompletnego grafu (używane w teście test_p3_production_does_not_apply_because_missing_vertex)
        self.node1 = Node(0, 0, 0)
        self.node2 = Node(5, 0, 0)
        self.node3 = Node(5, 5, 0)
        self.node5 = Node(5, 2.5, 1)
        ...
        self.incomplete_graph.add_node(self.node1)
        self.incomplete_graph.add_node(self.node2)
        self.incomplete_graph.add_node(self.node3)
        self.incomplete_graph.add_node(self.node5)
        self.incomplete_graph.add_node(self.node6)
        self.incomplete_graph.add_edge(self.node1, self.node6)
        self.incomplete_graph.add_edge(self.node6, self.node2)
        self.incomplete_graph.add_edge(self.node2, self.node5)
        self.incomplete_graph.add_edge(self.node5, self.node3)
        # Celowo pomijamy czwarty węzeł i jego krawędzie

    def setUpIncompleteGraphWithMissingEdge(self):
        # Ustawienie dla grafu z brakującą krawędzią (używane w teście test_p3_production_does_not_apply_because_missing_edge)
        self.node1 = Node(0, 0, 0)
        self.node2 = Node(5, 0, 0)
        self.node3 = Node(5, 5, 0)
        self.node4 = Node(0, 5, 0)
        self.node5 = Node(5, 2.5, 1)
        self.node6 = Node(2.5, 0, 1)
        self.missing_edge = Graph()
        self.missing_edge.add_node(self.node1)
        self.missing_edge.add_node(self.node2)
        self.missing_edge.add_node(self.node3)
        self.missing_edge.add_node(self.node4)
        self.missing_edge.add_node(self.node5)
        self.missing_edge.add_node(self.node6)
        self.qnode = self.missing_edge.add_q_node(self.node1, self.node2, self.node3, self.node4)
        self.qnode.R = 1
        self.missing_edge.add_edge(self.node1, self.node6)
        self.missing_edge.add_edge(self.node6, self.node2)
        self.missing_edge.add_edge(self.node2, self.node5)
        self.missing_edge.add_edge(self.node5, self.node3)
        self.missing_edge.add_edge(self.node4, self.node1)

    def setUpGraphWithIncorrectR(self):
        # Ustawienie dla grafu z niepoprawną wartością R (używane w teście test_p3_production_does_not_apply_because_incorrect_R)
        ...
        self.incorrect_r_node6 = Node(2.5, 0, 1)
        ...
        self.incorrect_r_graph.add_edge(self.incorrect_r_node1, self.incorrect_r_node6)
        self.incorrect_r_graph.add_edge(self.incorrect_r_node6, self.incorrect_r_node2)
    ...
    def test_p3_production_applies(self):
    ...
    def test_p3_production_applies_to_rolled_graph(self):
    ...
    def test_p3_production_applies_to_larger_graph(self):
    ...
    def test_p3_production_does_not_apply_because_missing_vertex(self):
    ...
    def test_p3_production_does_not_apply_because_missing_edge(self):
        self.setUpIncompleteGraphWithMissingEdge()  # Ustawienie grafu z brakującą krawędzią dla tego testu
        # self.missing_edge.visualize()
        prod = P3()
        results = list(prod.search_for_subgraphs(self.missing_edge))

        # Sprawdź, czy nie znaleziono podgrafów (produkcja nie powinna być stosowana z brakującą krawędzią)
        self.assertEqual(len(results), 0)

    def test_p3_production_does_not_apply_because_incorrect_R(self):
