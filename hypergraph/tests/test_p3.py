...
class TestP3Production(unittest.TestCase):
    ...
    def setUpIncompleteGraphWithMissingEdge(self):
        ...
        self.missing_edge_node5 = Node(5, 2.5, 1)
        self.missing_edge_node6 = Node(2.5, 0, 1)
        ...
        self.missing_edge_graph.add_edge(self.missing_edge_node2, self.missing_edge_node5)
        self.missing_edge_graph.add_edge(self.missing_edge_node5, self.missing_edge_node3)
        self.missing_edge_graph.add_edge(self.missing_edge_node3, self.missing_edge_node4)
    ...
    #     # Ustawienie dla grafu z niepoprawnymi współrzędnymi (używane w teście test_p3_production_does_not_apply_because_incorrect_coordinates)
    ...
    # def test_p3_production_does_not_apply_because_incorrect_coordinates(self):
