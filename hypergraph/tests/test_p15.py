...
class TestP15Production(unittest.TestCase):
    ...
    def test_p15_production_does_not_apply_because_missing_vertex(self):
    ...
    def test_p15_production_does_not_apply_because_missing_edge(self):
    ...
    def test_p15_production_does_not_apply_because_incorrect_R(self):
